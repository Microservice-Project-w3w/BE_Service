...
public class DeliveryTaskController {
    ...
    public DeliveryTaskResponse createTask(@Valid @RequestBody CreateDeliveryTaskRequest request) {
    ...
    public DeliveryTaskResponse updateTaskStatus(
        ...
        return service.updateTaskStatus(id, request, currentUserId);
    }

    @GetMapping("/staff/{staffUserId}")
    public List<DeliveryTaskResponse> getTasksByStaff(@PathVariable Long staffUserId) {
        return service.getTasksByStaff(staffUserId);
    }

    @GetMapping("/schedule")
    public List<DeliveryTaskResponse> getTasksByDate(@RequestParam String date) {
