...
public record DiscountCodeResponse(Long id, Long organizationId, Long branchId, String code, String name,
                                   DiscountType discountType, BigDecimal discountValue, BigDecimal maxDiscount,
                                   BigDecimal minOrderValue, String customerGroup, LocalDateTime validFrom,
